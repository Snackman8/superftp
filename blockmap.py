class Blockmap():
    ...
    def __init__(self, remote_path, local_path, file_size_func):
        ...
        if not os.path.exists(self._blockmap_path):
            ...
            filesize = file_size_func(self._remote_path)
    ...
    def allocate_segment(self, worker_id):
        ...
        blockmap = self.read_blockmap()
        for i in range(self.max_segment_size, 0, -1):
            blocks = i
